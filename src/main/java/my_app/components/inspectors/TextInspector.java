...
public class TextInspector implements Inspector<TextComponent> {
    ...
    public TextInspector(TextComponent component, HomeViewModel viewModel) {
    ...
    public void appearance(VBox father, CanvaComponentV2 canva) {
        father.getChildren().setAll(
                ...
                Components.ColorPickerRow(translation.fontColor(), component
                        , "-fx-fill"),
                ...
                Components.LabelWithInput(translation.width(), component, "text-wrapping-width"),
