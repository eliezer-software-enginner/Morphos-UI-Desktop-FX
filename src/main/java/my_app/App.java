...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // 🛑 REMOÇÃO CRUCIAL: App NÃO deve mais ser excluído para que o HotReload possa
        // carregá-lo
        ...
        stage.getIcons().add(
                new Image(Objects.requireNonNull(getClass().getResourceAsStream("/assets/app_ico_window_32_32.png"))));
    ...
    // Este método será chamado pelo start() e também pelo UIReloaderImpl1 (via
    // Reflection)
    ...
    public static void reinitScene(Stage stage) throws Exception {
        ...
        // O AppScenes.HomeScene() será resolvido pelo ClassLoader que carregou a nova
        // AppScenes.java.
